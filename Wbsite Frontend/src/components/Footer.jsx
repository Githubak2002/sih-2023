...
const Footer = () => {
  return (
    <div className="bg-[#192a36] text-white py-12">
      <h1 className="text-center text-3xl font-bold mb-8">WellMind Junction</h1>
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-8">
          <p className="text-gray-400">&copy; {new Date().getFullYear()}WellMind Junction  — All rights reserved</p>
        </div>
      </div>
    </div>
  );
